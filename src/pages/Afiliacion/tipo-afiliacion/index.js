...
const endPoint = 'http://127.0.0.1:8000/show_tipo_afiliacion/'
...
const AppPage = ({}) => {
  ...
  const handleSi = () => {
    if (deleteRow(registroSeleccionado.id, '/update_tipo_afiliacion/')) {
      toast.success(t('Record deleted successfully!'))
      router.push('./tipo-afiliacion')
    } else {
...
//*********GUARDAR OPC 2 ACTUALIZA DATATABLE MUESTRA REGISTRO*********************************
const onSubmit = async data => {
 if (await saveRow(data, '/store_tipo_afiliacion/')) {
  toast.success(t('Log saved successfully!'));
  router.replace('./tipo-afiliacion');
 } else {
...
//*********GUARDAR OPC 1 NO ACTUALIZA DATATABLE NO MUESTRA REGISTRO NUEVO*********************************
  // const onSubmit = data => {
  //   if (saveRow(data, '/store_tipo_afiliacion/')) {
  //     toast.success(t('Log saved successfully!'))
  //     // router.push('./tipo-afiliacion')
  //     router.replace('./tipo-afiliacion')
  //   } else {
...
//********************************************* */
  ...
  const onSubmitEdit = e => {
    e.preventDefault()
    if (saveRow(registroSeleccionado, '/store_tipo_afiliacion/')) {
