...
const endPoint = 'http://127.0.0.1:8000/show_agendas/'
...
const AppPage = ({}) => {
  ...
  const columns = [
      ...
      },
    {
      flex: 0.15,
      minWidth: 120,
      field: 'duracion_citas',
      headerName: t('appointment_duration')
    },
    {
      flex: 0.15,
      minWidth: 90,
    ...
    },
    {
      ...
      },
      {
        flex: 0.25,
        minWidth: 230,
        field: 'profesionales_asistentes',
        headerName:t('assistant professionals')
      },
      {
        flex: 0.25,
        minWidth: 130,
      ...
      },
      {
        ...
        minWidth: 130,
        field: 'multisede',
        headerName:t('multisite')
      },
      {
        flex: 0.25,
        minWidth: 130,
        field: 'agenda_grupo',
        headerName:t('Group Agenda')
      },
  ...
  const table = (
    <DataGrid
      ...
      columnVisibilityModel={{ id: false, create_up: false, comite:false, multisede:false }}
      slotProps={{
        baseButton: {
          size: 'medium',
          variant: 'outlined'
