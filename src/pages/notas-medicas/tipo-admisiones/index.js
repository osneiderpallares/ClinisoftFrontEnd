...
const endPoint = 'http://127.0.0.1:8000/show_tipo_admision/'
...
const AppPage = ({}) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      minWidth: 100,
      field: 'n_servicios',
      headerName:  'n_servicios',
      renderCell: (params) => (
        <Checkbox checked={params.value} disabled={false}  />
      ),
    },
    {
      flex: 0.25,
    ...
    },
    {
      flex: 0.25,
      minWidth: 100,
      field: 'facturar_directo',
      headerName:  'facturar_directo',
      renderCell: (params) => (
        <Checkbox checked={params.value} disabled={false}  />
      ),
    },  
  ...
  const handleSi = () => {
    if (deleteRow(registroSeleccionado.id, '/update_tipo_admision/')) {
      toast.success(t('Record deleted successfully!'))
      router.push('./tipo-admisiones')
    } else {
  ...
  const schema = yup.object().shape({
    ...
    n_servicios: yup
    .string()
    .min(3, obj => showErrors('servicios', obj.value.length, obj.min))
    .required(),
    n_inventario: yup
    .string()
    .min(3, obj => showErrors('inventario', obj.value.length, obj.min))
    .required(),
    n_medico: yup
    .string()
    .min(3, obj => showErrors('medico', obj.value.length, obj.min))
    .required(),
    n_remision: yup
    .string()
    .min(3, obj => showErrors('remision', obj.value.length, obj.min))
    .required(),
    facturar_directo: yup
    .string()
    .min(3, obj => showErrors('facturar directo', obj.value.length, obj.min))
    .required(),
    items_manual: yup
    .string()
    .min(3, obj => showErrors('items manual', obj.value.length, obj.min))
    .required(),
    estado: yup.string()
  })
  ...
  const onSubmit = data => {
    if (saveRow(data, '/store_tipo_admision/')) {
  ...
  const onSubmitEdit = e => {
    e.preventDefault()
    if (saveRow(registroSeleccionado, '/store_tipo_admision/')) {
  ...
  const table = (
    <DataGrid
      ...
      columnVisibilityModel={{ id: false, create_up: false, n_servicios:false,n_inventario:false,n_medico:false,n_remision:false,facturar_directo:false,items_manual:false }}
      slotProps={{
        baseButton: {
          size: 'medium',
          variant: 'outlined'
          ...
          >
            ...
            <Grid container spacing={6}>
              <input
                ...
                onChange={e => {
                  setRegistroSeleccionado({
                    ...
                    n_servicios: registroSeleccionado.n_servicios,
                    n_inventario: registroSeleccionado.n_inventario,
                    n_medico: registroSeleccionado.n_medico,
                    n_remision: registroSeleccionado.n_remision,
                    facturar_directo: registroSeleccionado.facturar_directo,
                    items_manual: registroSeleccionado.items_manual,
              ...
              <Grid item sm={4} xs={2}>
                n_servicios                
                <Checkbox
                //checked={registroSeleccionado.n_servicios}
                checked={typeof registroSeleccionado.n_servicios === 'boolean' ? registroSeleccionado.n_servicios : false}
              ...
              <Grid item sm={4} xs={2}>
                n_inventario
                <Checkbox                
                checked={typeof registroSeleccionado.n_inventario === 'boolean' ? registroSeleccionado.n_inventario : false}
                onChange={e => {
                    setRegistroSeleccionado({
                    ...registroSeleccionado,
                    id: registroSeleccionado.id,
              ...
              <Grid item sm={4} xs={2}>
                n_medico
                <Checkbox
                checked={typeof registroSeleccionado.n_medico === 'boolean' ? registroSeleccionado.n_medico : false}
                onChange={e => {
                    setRegistroSeleccionado({
                    ...registroSeleccionado,
                    id: registroSeleccionado.id,
              ...
              <Grid item sm={4} xs={2}>
                n_remision
                <Checkbox
                checked={typeof registroSeleccionado.n_remision === 'boolean' ? registroSeleccionado.n_remision : false}
                onChange={e => {
                    setRegistroSeleccionado({
                    ...registroSeleccionado,
                    id: registroSeleccionado.id,
              ...
              <Grid item sm={4} xs={2}>
                facturar_directo
                <Checkbox
                checked={typeof registroSeleccionado.facturar_directo === 'boolean' ? registroSeleccionado.facturar_directo : false}
                onChange={e => {
                    setRegistroSeleccionado({
                    ...registroSeleccionado,
                    id: registroSeleccionado.id,
                    ...
                    n_medico: registroSeleccionado.n_medico,
                    n_remision: registroSeleccionado.n_remision,
                    facturar_directo: e.target.checked,
                    items_manual: registroSeleccionado.items_manual,
                    estado: registroSeleccionado.estado
                    });
                }}
              ...
              <Grid item sm={4} xs={2}>
                items_manual
                <Checkbox
                checked={typeof registroSeleccionado.items_manual === 'boolean' ? registroSeleccionado.items_manual : false}
                onChange={e => {
                    setRegistroSeleccionado({
                    ...registroSeleccionado,
                    id: registroSeleccionado.id,
